...
class ResNet1D(nn.Module):
    def __init__(self, block, num_blocks, n_channels=32, n_classes=16):
...
def ResNet18_1D(n_channels=32, n_classes=16):
    return ResNet1D(BasicBlock, [2, 2, 2, 2], n_channels=n_channels, n_classes=n_classes)
